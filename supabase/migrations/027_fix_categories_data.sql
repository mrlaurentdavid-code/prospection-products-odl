-- ============================================
-- MIGRATION 027: Fix corrupted categories data
-- ============================================
-- Description: Nettoie et réinsère les catégories correctement
-- ============================================

-- Supprimer toutes les catégories et sous-catégories existantes
TRUNCATE prospection.categories CASCADE;
TRUNCATE prospection.subcategories CASCADE;
...
-- Reset les sequences pour éviter les conflits futurs
SELECT setval('prospection.categories_id_seq', (SELECT MAX(id) FROM prospection.categories));
SELECT setval('prospection.subcategories_id_seq', (SELECT MAX(id) FROM prospection.subcategories));
...
BEGIN
  ...
  RAISE NOTICE 'Catégories réinsérées: %', cat_count;
  RAISE NOTICE 'Sous-catégories réinsérées: %', subcat_count;
  ...
  RAISE NOTICE '✅ Migration 027 réussie - Catégories corrigées';
END $$;
